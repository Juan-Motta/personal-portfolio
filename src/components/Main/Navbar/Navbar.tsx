...
function Navbar(): JSX.Element {
    ...
    return (
        <nav className="mt-5 flex justify-between items-center md:flex-row flex-col">
            ...
            <ul
                ref={menuListRef}
                className="pt-12 text-3xl md:text-lg md:flex-row flex-col items-center gap-5 md:static absolute justify-evenly md:py-0 -top-[60rem] transition-all duration-300 md:transition-none md:duration-0 opacity-0 md:opacity-100 h-full w-full md:h-auto md:w-auto flex z-10 backdrop-blur-xl md:backdrop-blur-0"
            >
